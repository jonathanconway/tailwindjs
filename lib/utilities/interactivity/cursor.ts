...
export const cursor_utilities = {
  ...
  cursor_zoom_out,
  cursor_arbitrary,
  cursor_not_arbitrary,
  cursor_context_arbitrary,
  cursor_vertical_arbitrary,
  cursor_no_arbitrary,
  cursor_all_arbitrary,
  cursor_col_arbitrary,
  cursor_row_arbitrary,
  cursor_n_arbitrary,
  cursor_e_arbitrary,
  cursor_s_arbitrary,
  cursor_w_arbitrary,
